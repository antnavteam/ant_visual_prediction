...
def clean(input):
    """clean the raw data by removing the coma (",") between each 3 digits of the numbers """
    tmpFile = "tmp.csv"
...
mainfolder = '/home/Oceane/Documents/LED_Arena_Experiment_28_Eye_Covered_Vf/' ### WRITE THE PATH TO THE FILE WITH RAW DATA CORRESPONDING TO THE MODULATION OF THE GAIN EXPERIMENT
list_idt=[]
ant={}
eye={}
order={}
...
os.chdir(r"/home/Oceane/Documents") ### WRITE THE PATH TO THE FILE WHERE YOU WANT THE NEW FILE TO BE CREATED
...
for idt in list_idt:
    ...
    for e in range (len(events[idt])):
        ...
        #FOURRIER
        autocor = sm.tsa.acf(Ang_speed_smooth[idt][start:end], nlags=len(Ang_speed_smooth[idt][start:end]))
        fourierTransform = np.fft.rfft(autocor)
        frequency = np.linspace(0, 1/(2*0.033), len(np.square(abs(fourierTransform))))
        argfourrier=np.argmax(np.square(abs(fourierTransform[10:])))+10
...
mainfolder = '/home/Oceane/Documents/LED_Arena_Experiment_29_bars_and_homogeneous_Vf/' ### WRITE THE PATH TO THE FILE WITH RAW DATA CORRESPONDING TO THE VISUAL STRUCTURE EXPERIMENT
...
mainfolder = '/home/Oceane/Documents/LED_Arena_Experiment_31_Heavy_balls_Vf/' ### WRITE THE PATH TO THE FILE WITH RAW DATA CORRESPONDING TO THE HEAVY BALL EXPERIMENT
...
mainfolder = '/home/Oceane/Documents/LED_Arena_Experiment_30_vertical_bars_Vf/' ### WRITE THE PATH TO THE FILE WITH RAW DATA CORRESPONDING TO THE VERTICAL BARS EXPERIMENT
